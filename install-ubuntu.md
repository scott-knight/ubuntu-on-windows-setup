...
3. Next, you will update the setting of Windows Terminal. Instructions are found [here](https://github.com/scott-knight/ubuntu-on-windows-setup/blob/main/configure-windows-terminal.md).
